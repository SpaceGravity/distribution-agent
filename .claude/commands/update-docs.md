...
/Lessons:Lessons: Document lessons learned, useful tips, or anything that can be useful in the future. Keep related things in a dedicated file; do not write unrelated things in one file.
...
Update relevant parts in system & architecture design,  SOP best practices or leasons for mistakes we made
